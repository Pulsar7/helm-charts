...
![Version: 0.1.11-alpha.1](https://img.shields.io/badge/Version-0.1.11--alpha.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.7.3.0](https://img.shields.io/badge/AppVersion-3.7.3.0-informational?style=flat-square)
...
| containers.radicale.image.tag | string | `"3.7.3.0"` | Container-Image-Tag (by default `.Chart.AppVersion` will be used) |
