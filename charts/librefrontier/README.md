...
![Version: 0.3.2-alpha.2](https://img.shields.io/badge/Version-0.3.2--alpha.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.0.1-dev](https://img.shields.io/badge/AppVersion-0.0.1--dev-informational?style=flat-square)
...
| httpAPIIngressRoute.entryPoints | list | `["web"]` | Entrypoints for HTTP-API-Service |
| httpAPIIngressRoute.routeMatch | string | `"PathPrefix(`/`)"` | Match for HTTP-API-Route |
...
| webUIIngressRoute.entryPoints | list | `[]` | Entrypoints for Web-UI-Service |
| webUIIngressRoute.routeMatch | string | `"Host(``)"` | Match for Web-UI-Route |
